...
function App() {
  ...
  /**We are defining a function here to send to our route's render property. This function allows all the route's props, as well as any custom props we would like
